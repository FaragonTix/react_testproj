      ...
      (function() {
        ...
        function createElement(type, config3, children) {
          ...
          if (type && type.defaultProps) {
            var defaultProps46 = type.defaultProps;
            for (propName in defaultProps46) {
              if (props[propName] === void 0) {
                props[propName] = defaultProps46[propName];
              }
            }
          }
          {
        ...
        function cloneElement4(element, config3, children) {
          ...
          if (config3 != null) {
            ...
            if (element.type && element.type.defaultProps) {
              defaultProps46 = element.type.defaultProps;
            }
            for (propName in config3) {
              if (hasOwnProperty.call(config3, propName) && !RESERVED_PROPS.hasOwnProperty(propName)) {
                if (config3[propName] === void 0 && defaultProps46 !== void 0) {
                  props[propName] = defaultProps46[propName];
                } else {
                  props[propName] = config3[propName];
                }
          ...
          };
          {
            ...
            Object.defineProperties(lazyType, {
              defaultProps: {
                configurable: true,
                get: function() {
                  return defaultProps46;
                },
                set: function(newDefaultProps) {
                  error("React.lazy(...): It is not supported to assign `defaultProps` to a lazy component import. Either specify them where the component is defined, or create a wrapping component around it.");
                  defaultProps46 = newDefaultProps;
        ...
        function validatePropTypes(element) {
          {
            ...
            if (propTypes12) {
              setCurrentlyValidatingElement(element);
              checkPropTypes(propTypes12, element.props, "prop", name, ReactDebugCurrentFrame.getStackAddendum);
              setCurrentlyValidatingElement(null);
      ...
      (function() {
        ...
        function unstable_scheduleCallback(priorityLevel, callback, options2) {
          ...
          if (typeof options2 === "object" && options2 !== null) {
            ...
            timeout = typeof options2.timeout === "number" ? options2.timeout : timeoutForPriorityLevel(priorityLevel);
          } else {
  ...
  var require_react_dom_development = __commonJS((exports) => {
    ...
    if (true) {
      (function() {
        ...
        var canUseDOM5 = !!(typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined");
        ...
        };
        {
          ...
          ReactControlledValuePropTypes.checkPropTypes = function(tagName, props) {
            checkPropTypes(propTypes12, props, "prop", tagName, ReactDebugCurrentFrame$2.getStackAddendum);
          };
        }
        ...
        };
        {
          ...
          var warnHyphenatedStyleName = function(name) {
            ...
            error("Unsupported style property %s. Did you mean %s?", name, camelize3(name.replace(msPattern$1, "ms-")));
          };
        ...
        var normalizeHTML;
        {
          ...
          canDiffStyleForHydrationWarning = canUseDOM5 && !document.documentMode;
        ...
        if (canUseDOM5 && "documentMode" in document) {
          documentMode = document.documentMode;
        }
        var canUseTextInputEvent = canUseDOM5 && "TextEvent" in window && !documentMode;
        var useFallbackCompositionData = canUseDOM5 && (!canUseCompositionEvent || documentMode && documentMode > 8 && documentMode <= 11);
        ...
        function startWatchingForValueChange(target, targetInst) {
          activeElement3 = target;
          activeElementInst = targetInst;
          activeElement3.attachEvent("onpropertychange", handlePropertyChange);
        }
        function stopWatchingForValueChange() {
          if (!activeElement3) {
            return;
          }
          activeElement3.detachEvent("onpropertychange", handlePropertyChange);
          activeElement3 = null;
        ...
        var skipSelectionChangeEvent = canUseDOM5 && "documentMode" in document && document.documentMode <= 11;
        var eventTypes$3 = {
          select: {
            phasedRegistrationNames: {
              bubbled: "onSelect",
        ...
        var formatLabel = function(label, warning15) {
          var prefix = warning15 ? warningEmoji + " " : reactEmoji + " ";
          var suffix = warning15 ? " Warning: " + warning15 : "";
        ...
        var endMark = function(label, markName, warning15) {
          var formattedMarkName = formatMarkName(markName);
          var formattedLabel = formatLabel(label, warning15);
          try {
        ...
        var endFiberMark = function(fiber, phase, warning15) {
          var componentName = getComponentName(fiber.type) || "Unknown";
          var debugID = fiber._debugID;
          var isMounted2 = fiber.alternate !== null;
          var label = getFiberLabel(componentName, isMounted2, phase);
          var markName = getFiberMarkName(label, debugID);
          endMark(label, markName, warning15);
        };
        ...
        function stopFailedWorkTimer(fiber) {
          {
            ...
            fiber._debugIsCurrentlyTiming = false;
            var warning15 = fiber.tag === SuspenseComponent ? "Rendering was suspended" : "An error was thrown inside this error boundary";
            endFiberMark(fiber, null, warning15);
          }
        }
        ...
        function stopPhaseTimer() {
          {
            ...
            if (currentPhase !== null && currentPhaseFiber !== null) {
              var warning15 = hasScheduledUpdateInCurrentPhase ? "Scheduled a cascading update" : null;
              endFiberMark(currentPhaseFiber, currentPhase, warning15);
            }
            currentPhase = null;
            currentPhaseFiber = null;
          }
        ...
        function stopWorkLoopTimer(interruptedBy2, didCompleteRoot) {
          {
            ...
            if (interruptedBy2 !== null) {
              if (interruptedBy2.tag === HostRoot) {
                warning15 = "A top-level update interrupted the previous render";
              } else {
                var componentName = getComponentName(interruptedBy2.type) || "Unknown";
                warning15 = "An update to " + componentName + " interrupted the previous render";
              }
            } else if (commitCountInCurrentWorkLoop > 1) {
              warning15 = "There were cascading updates";
            }
            commitCountInCurrentWorkLoop = 0;
            var label = didCompleteRoot ? "(React Tree Reconciliation: Completed Root)" : "(React Tree Reconciliation: Yielded)";
            pauseTimers();
            endMark(label, "(React Tree Reconciliation)", warning15);
          }
        }
        ...
        function stopCommitTimer() {
          {
            ...
            if (hasScheduledUpdateInCurrentCommit) {
              warning15 = "Lifecycle hook scheduled a cascading update";
            } else if (commitCountInCurrentWorkLoop > 0) {
              warning15 = "Caused by a cascading update in earlier commit";
            }
            hasScheduledUpdateInCurrentCommit = false;
            commitCountInCurrentWorkLoop++;
            isCommitting = false;
            labelsInCurrentCommit.clear();
            endMark("(Committing Changes)", "(Committing Changes)", warning15);
          }
        }
        ...
        function resolveDefaultProps(Component, baseProps) {
          if (Component && Component.defaultProps) {
            ...
            var defaultProps46 = Component.defaultProps;
            for (var propName in defaultProps46) {
              if (props[propName] === void 0) {
                props[propName] = defaultProps46[propName];
              }
            }
        ...
        function mountReducer(reducer, initialArg, init) {
          ...
          hook2.memoizedState = hook2.baseState = initialState;
          var queue = hook2.queue = {
            pending: null,
            dispatch: null,
        ...
        function mountEffectImpl(fiberEffectTag, hookEffectTag, create, deps) {
          ...
          hook2.memoizedState = pushEffect(HasEffect | hookEffectTag, create, void 0, nextDeps);
        }
        function updateEffectImpl(fiberEffectTag, hookEffectTag, create, deps) {
          ...
          currentlyRenderingFiber$1.effectTag |= fiberEffectTag;
          hook2.memoizedState = pushEffect(HasEffect | hookEffectTag, create, destroy, nextDeps);
        }
        ...
        function mountTransition(config3) {
          ...
          var start2 = mountCallback(startTransition.bind(null, setPending, config3), [setPending, config3]);
        ...
        function updateTransition(config3) {
          ...
          var start2 = updateCallback(startTransition.bind(null, setPending, config3), [setPending, config3]);
          return [start2, isPending];
        }
...
For more info, visit https://fb.me/react-mock-scheduler`);
        ...
        function injectInternals(internals) {
          ...
          try {
            var rendererID = hook2.inject(internals);
            if (true) {
              if (typeof hook2.onScheduleFiberRoot === "function") {
                onScheduleFiberRoot = function(root2, children) {
                  try {
                    hook2.onScheduleFiberRoot(rendererID, root2, children);
                  } catch (err) {
                    if (!hasLoggedError) {
                      hasLoggedError = true;
            ...
            onCommitFiberRoot = function(root2, expirationTime) {
              try {
                ...
                if (enableProfilerTimer) {
                  ...
                  var priorityLevel = inferPriorityFromExpirationTime(currentTime, expirationTime);
                  hook2.onCommitFiberRoot(rendererID, root2, priorityLevel, didError);
                } else {
                  hook2.onCommitFiberRoot(rendererID, root2, void 0, didError);
                }
              } catch (err) {
                if (true) {
                  if (!hasLoggedError) {
            ...
            onCommitFiberUnmount = function(fiber) {
              try {
                hook2.onCommitFiberUnmount(rendererID, fiber);
              } catch (err) {
                if (true) {
                  if (!hasLoggedError) {
                    hasLoggedError = true;
        ...
        {
          if (!foundDevTools && canUseDOM5 && window.top === window.self) {
  ...
  var timeoutsShape = prop_types18.default.oneOfType([prop_types18.default.number, prop_types18.default.shape({
    enter: prop_types18.default.number,
    exit: prop_types18.default.number,
    appear: prop_types18.default.number
  }).isRequired]);
  var classNamesShape = prop_types18.default.oneOfType([prop_types18.default.string, prop_types18.default.shape({
    enter: prop_types18.default.string,
    exit: prop_types18.default.string,
    active: prop_types18.default.string
  }), prop_types18.default.shape({
    enter: prop_types18.default.string,
    enterDone: prop_types18.default.string,
    enterActive: prop_types18.default.string,
    exit: prop_types18.default.string,
    exitDone: prop_types18.default.string,
    exitActive: prop_types18.default.string
  })]);

  // node_modules/react-transition-group/esm/TransitionGroupContext.js
  const react122 = __toModule(require_react());
  const TransitionGroupContext_default = react122.default.createContext(null);
  ...
  var ENTERED = "entered";
  var EXITING = "exiting";
  var Transition6 = function(_React$Component) {
    _inheritsLoose(Transition8, _React$Component);
    function Transition8(props, context4) {
      var _this;
    ...
    Transition8.getDerivedStateFromProps = function getDerivedStateFromProps(_ref, prevState) {
      var nextIn = _ref.in;
    ...
    var _proto = Transition8.prototype;
    ...
    _proto.performEnter = function performEnter(mounting) {
      ...
      var _ref2 = this.props.nodeRef ? [appearing] : [react_dom5.default.findDOMNode(this), appearing], maybeNode = _ref2[0], maybeAppearing = _ref2[1];
    ...
    _proto.performExit = function performExit() {
      ...
      var timeouts = this.getTimeouts();
      var maybeNode = this.props.nodeRef ? void 0 : react_dom5.default.findDOMNode(this);
    ...
    _proto.onTransitionEnd = function onTransitionEnd(timeout, handler) {
      ...
      var node = this.props.nodeRef ? this.props.nodeRef.current : react_dom5.default.findDOMNode(this);
    ...
    _proto.render = function render() {
      ...
      return react120.default.createElement(TransitionGroupContext_default.Provider, {
        value: null
      }, typeof children === "function" ? children(status, childProps) : react120.default.cloneElement(react120.default.Children.only(children), childProps));
    };
    return Transition8;
  }(react120.default.Component);
  Transition6.contextType = TransitionGroupContext_default;
  Transition6.propTypes = {
    nodeRef: prop_types16.default.shape({
      current: typeof Element === "undefined" ? prop_types16.default.any : prop_types16.default.instanceOf(Element)
    }),
    children: prop_types16.default.oneOfType([prop_types16.default.func.isRequired, prop_types16.default.element.isRequired]).isRequired,
    in: prop_types16.default.bool,
    mountOnEnter: prop_types16.default.bool,
    unmountOnExit: prop_types16.default.bool,
    appear: prop_types16.default.bool,
    enter: prop_types16.default.bool,
    exit: prop_types16.default.bool,
    ...
    addEndListener: prop_types16.default.func,
    onEnter: prop_types16.default.func,
    onEntering: prop_types16.default.func,
    onEntered: prop_types16.default.func,
    onExit: prop_types16.default.func,
    onExiting: prop_types16.default.func,
    onExited: prop_types16.default.func
  };
  function noop6() {
  }
  Transition6.defaultProps = {
    in: false,
    mountOnEnter: false,
    unmountOnExit: false,
    appear: false,
  ...
  Transition6.UNMOUNTED = UNMOUNTED;
  Transition6.EXITED = EXITED;
  Transition6.ENTERING = ENTERING;
  Transition6.ENTERED = ENTERED;
  Transition6.EXITING = EXITING;
  const Transition_default = Transition6;
  ...
  var CSSTransition = function(_React$Component) {
    ...
    function CSSTransition3() {
      ...
      _this.getClassNames = function(type) {
        var classNames69 = _this.props.classNames;
        var isStringClassNames = typeof classNames69 === "string";
        var prefix = isStringClassNames && classNames69 ? classNames69 + "-" : "";
        var baseClassName = isStringClassNames ? "" + prefix + type : classNames69[type];
        var activeClassName = isStringClassNames ? baseClassName + "-active" : classNames69[type + "Active"];
        var doneClassName = isStringClassNames ? baseClassName + "-done" : classNames69[type + "Done"];
        return {
          baseClassName,
          activeClassName,
          doneClassName
    ...
    _proto.render = function render() {
      ...
      return react117.default.createElement(Transition_default, _extends({}, props, {
  ...
  }(react117.default.Component);
  CSSTransition.defaultProps = {
    classNames: ""
  };
  CSSTransition.propTypes = _extends({}, Transition_default.propTypes, {
    classNames: classNamesShape,
    onEnter: prop_types13.default.func,
    onEntering: prop_types13.default.func,
    onEntered: prop_types13.default.func,
    onExit: prop_types13.default.func,
    onExiting: prop_types13.default.func,
    onExited: prop_types13.default.func
  });
  const CSSTransition_default = CSSTransition;

  // src/App.js
  const react126 = __toModule(require_react());
  const react_dom6 = __toModule(require_react_dom());
  ples = true;
  const appRoot = document.getElementById("root");
  class PageOne extends react126.default.Component {
    render() {
      document.title = "Главная";
      return react126.default.createElement("div", null, "Текст Текст Текст Текст Текст ");
    }
  }
  function PageTwo(props) {
    document.title = "кнопка вторая";
    return react126.default.createElement("div", null, "Кнопка 2");
  }
  function PageThree(props) {
    document.title = "кнопка третья";
    return react126.default.createElement("div", null, "Кнопка 3");
  }
  class Logotype extends react126.default.Component {
    render() {
      var logostyle = {
        zIndex: 1,
        position: "absolute",
      ...
      return react126.default.createElement("img", {
        src: this.props.piclogo,
        style: logostyle,
        onClick: this.props.onClick
      });
    }
  }
  class LogoS extends react126.default.Component {
    constructor(props) {
      super(props);
      this.state = {
        an: "0px",
    ...
    render() {
      ...
      let logo;
      let barelement;
      logo = react126.default.createElement(Logotype, {
        piclogo: "/logoS.png",
        onClick: this.capp
      });
      barelement = react126.default.createElement(LeftBar, {
        ...this.props
      });
      if (isem) {
        barel = barelement;
      } else {
        barel = react126.default.createElement("div", null, " ");
      }
      return react126.default.createElement(react126.default.Fragment, null, react126.default.createElement(CSSTransition_default, {
        classNames: "alert",
        in: isBar,
        timeout: 1e3,
        onExited: () => this.maunting()
      }, barel), logo);
    }
  }
  class Header extends react126.default.Component {
    render() {
      var head = {
        zIndex: 1,
        padding: 20,
      ...
      return react126.default.createElement("div", {
        style: head
      }, react126.default.createElement("b", null, this.props.headname));
    }
  }
  class ButtonLeft extends react126.default.Component {
    constructor(props) {
      super(props);
      this.state = {
        strikes: "white",
    ...
    render() {
      ...
      if (mobileT) {
        return react126.default.createElement("button", {
          onMouseEnter: this.ment,
          style: bssmobile,
          onMouseLeave: this.mout,
          onClick: this.props.act
  ...
  class Mm extends react126.default.Component {
    constructor(props) {
      super(props);
    ...
    render() {
      ...
      let content;
      if (buttonC === 1) {
        content = react126.default.createElement(PageOne, null);
      }
      if (buttonC === 2) {
        content = react126.default.createElement(PageTwo, null);
      }
      if (buttonC === 3) {
        content = react126.default.createElement(PageThree, null);
      }
      return react126.default.createElement("div", null, react126.default.createElement(LogoS, {
        act1: this.act1,
        act2: this.act2,
        act3: this.act3
      }), react126.default.createElement(Main, null, content));
    }
  }
  class LeftBar extends react126.default.Component {
    constructor(props) {
      super(props);
      this.state = {
        isMobile: false
    ...
    render() {
      ...
      if (mobileT) {
        return react126.default.createElement("div", {
          style: barmobile
        }, react126.default.createElement(ButtonLeft, {
          butonname: "Справочник",
          topmargin: "100px",
          act: this.props.act1
        }), react126.default.createElement(ButtonLeft, {
          butonname: "Справочник",
  ...
  class Main extends react126.default.Component {
    constructor(props) {
      super(props);
      this.state = {
        isMobile: false
  ...
  react_dom6.default.render(react126.default.createElement("div", null, react126.default.createElement(Header, {
    headname: "Site name"
  }), react126.default.createElement(Mm, null)), appRoot);
})();
